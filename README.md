...
This is a wizard can assist build programing enviroment. Choose programing language and editor, and this wizard will install them on Arch Linux(Manjaro/Alter Linux and other Arch derived distribution).
...
Please follow my Twitter account (@Watasuke102) and my Github account, Star this repository!
